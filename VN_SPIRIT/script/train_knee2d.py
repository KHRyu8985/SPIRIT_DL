...
def create_argparser():
    ...
    parser.add_argument('--name', type=str, default='E2EVN_knee2D',
                        help='Weight_name') 
...
def main(args):
    ...
    trainset = Data2D('../data/div_knee2d/Train', dset_type='knee2d')

    validset = Data2D('../data/div_knee2d/Val', dset_type='knee2d')
